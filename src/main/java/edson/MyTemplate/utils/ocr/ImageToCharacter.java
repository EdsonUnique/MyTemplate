 ...
 * 阿里云 图片识别
 */
public class ImageToCharacter {

    public static void main(String[] args) throws Exception {
        IClientProfile profile = DefaultProfile
                .getProfile("cn-shanghai", "LTAIwldfT064Vr9i", "5roXJGccaJMRnMAzDDWDMjNnopcLVO");
        DefaultProfile
...
//            }
            ...
            url = uploader.uploadFile("C:\\Users\\Administrator\\Desktop\\invoice.jpg");
        }catch (Exception e){
                    ...
                    if(200 == taskCode){
                        for (Object sceneResult : sceneResults) {
                            ...
                            if("review" .equals(suggestion) && "ocr".equals(scene)){
                                JSONObject idCardInfo =  ((JSONObject) sceneResult).getJSONObject("invoiceInfo");
